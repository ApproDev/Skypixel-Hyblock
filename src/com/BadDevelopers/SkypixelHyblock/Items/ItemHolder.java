...
public interface ItemHolder {
	public enum Item {
		...
		BOOMERANG(Material.BONE, "Skelerang", Category.WEAPONS, true, true, new Stat[] {Stat.Strength}, new Integer[] {10}),
		SLINGSHOT(Material.PHANTOM_MEMBRANE, "Slingshot", Category.WEAPONS, true, true, new Stat[] {Stat.Strength}, new Integer[] {10}),
		...
		BONE_PIECE("http://textures.minecraft.net/texture/86ce9b18ca238ead6515b0173534a7f34d28bc51c0188e2db06845c17e62f10a", "Bone Piece", Category.MATERIAL),
		STONE_OF_RECOLLECTION("http://textures.minecraft.net/texture/9ad07bc6a4ca6a2f93b9dd7c7fe1fcbd587e69e1c28d52485d6f82cc1910d8e0", "Stone of Recollection", Category.MATERIAL),
...
/*TODO get texture*/		TREASURE_ARTIFACT("http://textures.minecraft.net/texture/e6b543464930e8d38676db6be9920dd82a54859c3497d9fe31ef92a884c84", "Treasure Artifact", Category.TALISMAN, "treasure", 5, false, new Stat[] {}, new Integer[] {}),
		...
		//playerhead items
		Item(String skinURL, String name, Category cat){
		...
		//weapons with stats
		Item(Material mat, String name, Category cat, boolean looksEnchanted, Stat[] stats, Integer[] statValues) {	
			this.mat = mat;
			this.name = name;
			this.cat = cat;
			this.looksEnchanted = looksEnchanted;
		...
		public ItemStack getItem(int quantity, Main main) {
			...
			if (unstackable) is = setRandomUnstackableKey(is);
	...
	public static ItemStack setRandomUnstackableKey(ItemStack is) {
		
		ItemMeta im = is.getItemMeta();
		
		PersistentDataContainer pdc = im.getPersistentDataContainer();
		
		pdc.set(new NamespacedKey(getInstance(), "unstackablerandom"), PersistentDataType.LONG, new Random().nextLong());
	...
	public static Boolean hasUnstackableKey(ItemStack is) {
		
		PersistentDataContainer pdc = is.getItemMeta().getPersistentDataContainer();
		
		Boolean isUnstackable = pdc.has(new NamespacedKey(getInstance(), "unstackablerandom"), PersistentDataType.LONG);
		
		return isUnstackable;	
	}
