...
public interface ItemHolder {
	public enum Item {
		...
		REDSTONE_CHEST(Material.LEATHER_CHESTPLATE, Color.fromRGB(175, 0, 0), ChatColor.DARK_RED+"Redstone Chestplate", Category.ARMOUR, false, 40),
		REDSTONE_LEGS(Material.LEATHER_LEGGINGS, Color.fromRGB(175, 0, 0), ChatColor.DARK_RED+"Redstone Leggings", Category.ARMOUR, false, 35),
		REDSTONE_BOOTS(Material.LEATHER_BOOTS, Color.fromRGB(175, 0, 0), ChatColor.DARK_RED+"Redstone Boots", Category.ARMOUR, false, 20),
		
		OBSIDIAN_HELM(Material.NETHERITE_HELMET, "Obsidian Helmet", Category.ARMOUR, false, 50),
		OBSIDIAN_CHEST(Material.NETHERITE_CHESTPLATE, "Obsidian Chestplate", Category.ARMOUR, false, 70),
		OBSIDIAN_LEGS(Material.NETHERITE_LEGGINGS, "Obsidian Leggings", Category.ARMOUR, false, 40),
		OBSIDIAN_BOOTS(Material.NETHERITE_BOOTS, "Obsidian Boots", Category.ARMOUR, false, 30),
		...
		WOOD_DAGGER(Material.WOODEN_SWORD, "Wooden Dagger", Category.WEAPONS),
		STONE_DAGGER(Material.STONE_SWORD, "Stone Dagger", Category.WEAPONS),
		IRON_DAGGER(Material.IRON_SWORD, "Iron Dagger", Category.WEAPONS),
		DIAMOND_DAGGER(Material.DIAMOND_SWORD, "Diamond Sword", Category.WEAPONS),
		ELUCIDATOR(Material.NETHERITE_SWORD, "The Elucidator", Category.WEAPONS),
		SKELERANG(Material.BONE, "Skelerang", Category.WEAPONS, true, true, new Stat[] {Stat.Strength}, new Integer[] {10}),
		ANGELS_BLESSING(Material.IRON_SWORD, "Angel's Blessing", Category.WEAPONS, false, true),
		DEVILS_MERCY(Material.NETHERITE_SWORD, "Devil's Mercy", Category.WEAPONS, false, true),
		
		
		//materials
		ENCHANTED_DIAMOND(Material.DIAMOND, "Enchanted Diamond", Category.MATERIAL, false, true),
...
/*TODO get texture*/		TREASURE_ARTIFACT("http://textures.minecraft.net/texture/e6b543464930e8d38676db6be9920dd82a54859c3497d9fe31ef92a884c84", "Treasure Artifact", Category.TALISMAN, "treasure", 5, false, new Stat[] {}, new Integer[] {}),
		...
		Item(Material mat, String name, Category cat, boolean looksEnchanted, boolean unstackable, Stat[] stats, Integer[] statValues) {
			this.mat = mat;
			this.name = name;
			this.cat = cat;
			this.looksEnchanted = looksEnchanted;
		...
		Item(Material mat, String name, Category cat, boolean isVanilla, Integer armour) {
			this(mat, name, cat, isVanilla);
			this.armour = armour;
		}
		
		Item(Material mat, String name, Category cat, boolean isVanilla, boolean looksEnchanted){
			this(mat, name, cat, isVanilla);
			this.looksEnchanted = looksEnchanted;
		}
