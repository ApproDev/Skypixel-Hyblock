...
import com.BadDevelopers.SkypixelHyblock.Anticheat.Generic;
...
import com.BadDevelopers.SkypixelHyblock.Items.IllegalItemCheck;
import com.BadDevelopers.SkypixelHyblock.Items.PlayerKarma;
...
public class Main extends JavaPlugin {
	...
	public static PlayerKarma karma;
	
	public static IllegalItemCheck illegalitemcheck;
	
	public static CustomWeaponsEventManager customweaponseventmanager;
	
	public static SoundHolder terrainSoundHolder;
	
	public static SoundHolder terrainSoundHolder2;
    ...
    public void onEnable() {
    	...
    	karma = new PlayerKarma();
    	currency = new Currency(this);
    	stats = new Stats();
    	reforgeholder = new ReforgeHolder(this);
    	customweaponseventmanager = new CustomWeaponsEventManager(this);
    	illegalitemcheck = new IllegalItemCheck();
    	...
    	pm.registerEvents(new PlayerKarma(), this);
