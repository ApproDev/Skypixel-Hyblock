...
public class Main extends JavaPlugin {
	...
	public void onLoad() {
		...
		try {
    		String s = this.getDataFolder().getPath();
    		
    		terrainSoundHolder = new SoundHolder(
    				new File(s+"/sound.wav").getAbsoluteFile());
    		
    		terrainSoundHolder2 = new SoundHolder(
    				new File(s+"/sound2.wav").getAbsoluteFile());
